...
//echo $count."<br>";
  ...
  <input type="submit" value="SUBMIT" style="background-color:#330a00;
    color: white;">
  </form>
  </div>
</div>
...
//$sql = "INSERT INTO `" . $name . "` VALUES ('".$present."','".$date."','".$name."')";
//$sql = "INSERT INTO `{$name}` VALUES ('".$count."','".$date."','".$name."')";
$sql = "INSERT INTO $name VALUES('','$date','PRESENT')";
...
$sql = "INSERT INTO $name VALUES('','$date','ABSENT')";
if (mysql_query($sql) === TRUE) 
{
echo "Congrats!!";
} else {
