...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-8">
      <form class="form-inline" role="form" action="home.php" method="POST">
    <div class="input-group">
<select class="form-control" id="select" name="sel" required>
...
<br><br><span class="btn btn-info"><?php echo "Hi!! ";echo $error; ?></span>
  </form>
    </div>
  </div>
</div>
